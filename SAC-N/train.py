...
def get_config():
    ...
    parser.add_argument("--run_name", type=str, default="SACN-discrete", help="Run name, default: CQL-SAC")
    ...
    with wandb.init(project="CQL", name=config.run_name, config=config):
        ...
        for i in range(1, config.episodes+1):
            ...
            if i % config.save_every == 0:
                save(config, save_name="SACN-discrete", model=agent.actor_local, wandb=wandb, ep=0)
