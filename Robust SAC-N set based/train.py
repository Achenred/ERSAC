...
def get_config():
    ...
    parser.add_argument("--batch_size", type=int, default=256*2, help="Batch size, default: 256")
...
def train(config):
    ...
    with wandb.init(project="CQL", name=config.run_name, config=config):
        ...
        for i in range(1, config.episodes+1):
            ...
            print("Episode: {} | Reward: {} | Policy Loss: {} | critic Loss: {} | Steps: {}".format(i, rewards, policy_loss, critic_loss, steps,))
